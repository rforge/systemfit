...
fitw2sls2e <- systemfit( system, "W2SLS", data = Kmenta, restrict.matrix = restrm,
   inst = inst, methodResidCov = "noDfCor", returnModelMatrix = TRUE,
   useMatrix = useMatrix )
...
fitw2sls3 <- systemfit( system, "W2SLS", data = Kmenta, restrict.regMat = tc,
   inst = inst, returnModelMatrix = TRUE, useMatrix = useMatrix )
...
fitw2slsd2e <- systemfit( system, "W2SLS", data = Kmenta, restrict.matrix = restrm,
   inst = instlist, methodResidCov = "noDfCor", returnModelMatrix = TRUE,
   useMatrix = useMatrix )
...
fitw2slsd3 <- systemfit( system, "W2SLS", data = Kmenta, restrict.regMat = tc,
   inst = instlist, returnModelMatrix = TRUE, useMatrix = useMatrix )
...
## **************** shorter summaries **********************
print( summary( fitw2sls1e, printResidCov = FALSE ) )

print( summary( fitw2sls2, printResidCov = FALSE, printEquations = FALSE ) )

print( summary( fitw2sls3, useDfSys = FALSE ), equations = FALSE )

print( summary( fitw2sls4e ), residCov = FALSE )

print( summary( fitw2sls5, useDfSys = FALSE, printResidCov = FALSE ) )

print( summary( fitw2slsd1, useDfSys = TRUE ), residCov = FALSE,
   equations = FALSE )

print( summary( fitw2slsd2e, printEquations = TRUE ), equations = FALSE )

print( summary( fitw2slsd3e, printEquations = FALSE ), residCov = FALSE )
