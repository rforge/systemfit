...
included in the \pkg{systemfit} package
(see the documentation of \code{GrunfeldGreen}, \code{GrunfeldTheil},
\code{KleinI} and \code{kmenta}).
}
...
in future releases of \pkg{systemfit}.
...
The \pkg{systemfit} package provides a function to estimate
systems of non-linear estimations.
However, the function \code{nlsystemfit} is currently under development
