...
This results in the linear independent parameter estimates $\widehat{\beta}^M$ and
...
\begin{equation}
   ...
   = M \cdot \COVHat \left[ \widehat{\beta}^M \right] \cdot M' .
\end{equation}
...
\begin{equation}
   \left[ \begin{array}{c}
      \widehat{\beta}^R_{OLS} \\ \widehat{\lambda}
   \end{array} \right]
   =
   \left[ \begin{array}{cc}
      X' X & R' \\ 
...
\begin{equation}
   \left[ \begin{array}{c}
      \widehat{\beta}^R_{WLS} \\ \widehat{\lambda}
   \end{array} \right]
   =
   \left[ \begin{array}{cc}
      X' \OHat^{-1} X & R' \\
...
\begin{equation}
   \left[ \begin{array}{c}
      \widehat{\beta}^R_{SUR} \\ \widehat{\lambda}
   \end{array} \right]
   =
   \left[ \begin{array}{cc}
      X' \OHat^{-1} X & R' \\
...
\begin{equation}
   \left[ \begin{array}{c}
      \widehat{\beta}^R_{2SLS} \\ \widehat{\lambda}
   \end{array} \right]
   =
   \left[ \begin{array}{cc}
...
\begin{equation}
   \left[ \begin{array}{c}
      \widehat{\beta}^R_{W2SLS} \\ \widehat{\lambda}
   \end{array} \right]
   =
   \left[ \begin{array}{cc}
      \widehat{X}' \OHat^{-1} \widehat{X} & R' \\
...
\begin{equation}
   \left[ \begin{array}{c}
      \widehat{\beta}^R_{3SLS} \\ \widehat{\lambda}
   \end{array} \right]
   =
   \left[ \begin{array}{cc}
      \widehat{X}' \OHat^{-1} \widehat{X} & R' \\
...
\begin{equation}
   \left[ \begin{array}{c}
      \widehat{\beta}^R_{3SLS-IV} \\ \widehat{\lambda}
   \end{array} \right]
   =
   \left[ \begin{array}{cc}
...
\begin{equation}
   \left[ \begin{array}{c}
      \widehat{\beta}^R_{3SLS-GMM} \\ \widehat{\lambda}
   \end{array} \right]
   =
   \left[ \begin{array}{cc}
...
\begin{equation}
   \left[ \begin{array}{c}
      \widehat{\beta}^R_{3SLS-Schmidt} \\ \widehat{\lambda}
   \end{array} \right]
   =
   \left[ \begin{array}{cc}
      \widehat{X}' \OHat^{-1} \widehat{X} & R' \\
...
\begin{equation}
   \left[ \begin{array}{c}
      \widehat{\beta}^R_{3SLS-EViews} \\ \widehat{\lambda}
   \end{array} \right]
   =
   \left[ \begin{array}{cc}
      \widehat{X}' \OHat^{-1} \widehat{X} & R' \\
   ...
   \cdot
   \left[ \begin{array}{c}
      \widehat{X}' \OHat^{-1} \left( y - X \widehat{\beta}^R_{2SLS} \right)
      \\ q 
   \end{array} \right] ,
   \label{eq:3slsEViewsR}
\end{equation}
where $\widehat{\beta}^R_{2SLS}$ is the restricted 2SLS estimator calculated
