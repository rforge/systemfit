...
estimated residual covariance matrix $hat{S}$ by the maximum likelihood
formula 
...
You should really get some of the text from your stats book. 
...
\code{systemfit}, nonlinear systems of equations can be estimated
using a similar function \code{nlsystemfit}. The usage for the
nonlinear estimation function is similar to \code{systemfit} and can
estimate system of equations using OLS, SUR, 2SLS and 3SLS methods.
