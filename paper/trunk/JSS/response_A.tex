...
We consider the presentation of the theoretical background
...
we think that the formulas and the usage should not be presented together.
Furthermore, our structure allows readers
who already know the theoretical background
to skip this entire section
and go immediately into the section they are interested in
(e.g.\ section °Using systemfit°).
Hence, they do not have to scan a large composite section
just to figure out a few commands of \pkg{systemfit}.
Readers who have skipped the section °Statistical background°,
...
However, in our opinion this shorting would considerably worsen
...
We have renamed single letter elements (not finished yet).
