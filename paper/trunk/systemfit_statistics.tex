...
of the functionality provided in the \pkg{systemfit} package.
After introducing notations and assumptions,
we provide the formulas to estimate linear equation systems.
Then, we shows how linear restrictions can be imposed.
Finally, some other relevant issues about estimation of equation systems
are discussed.
