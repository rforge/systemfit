...
the covariance matrix of the estimated parameters is
\begin{equation}
   \Cov \left[ \widehat{\beta} \right] = \left( X' \Omega^{-1} X \right)^{-1}
...
the covariance matrix of the estimated parameters is
\begin{equation}
   \Cov \left[ \widehat{\beta} \right] = \sigma^2 \left( \widehat{X}'
   \widehat{X} \right)^{-1}
...
the covariance matrix of the estimated parameters is
\begin{equation}
   \Cov \left[ \widehat{\beta} \right] = \left( \widehat{X}' \Omega^{-1}
   \widehat{X} \right)^{-1}
...
\begin{equation}
   ...
   \label{eq:3slsIv}
\end{equation}
The covariance matrix of this IV-3SLS estimator is:
\begin{equation}
   \Cov \left[ \widehat{\beta} \right] = \left( \widehat{X}' \Omega^{-1}
   X \right)^{-1}
\end{equation}
...
\begin{equation}
   ...
   \label{eq:3slsGmm}
\end{equation}
The covariance matrix of the GMM-3SLS estimator is:
\begin{equation}
