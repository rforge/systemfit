...
If no cross-equation restrictions on the coefficients are imposed, the simultaneous
...
If no cross-equation restrictions on the coefficients are imposed,
the estimated coefficients are equal to OLS estimates.
...
$\sHat_{ii} = \sHat_i^2$.
If no cross-equation restrictions on the coefficients are imposed,
the estimated coefficients are equal to 2SLS estimates.
