...
\begin{equation}
   \bHat_{2SLS} = \left( \widehat{X}' \widehat{X} \right)^{-1}
   \widehat{X}' y .
   \label{eq:beta2sls}
\end{equation}
If the whole system is treated as one single equation,
an estimator of the covariance matrix of the estimated parameters is
\begin{equation}
   \COVHat \left[ \bHat_{2SLS} \right] = \sHat^2 \left( \widehat{X}'
   \widehat{X} \right)^{-1} ,
...
an estimator of the covariance matrix of the estimated parameters is
\begin{equation}
   \COVHat \left[ \bHat_{2SLS} \right] = \left( \widehat{X}' \OHat^{-1}
   \widehat{X} \right)^{-1} ,
...
is obtained by
\begin{equation}
   \bHat_{W2SLS} = \left( \widehat{X}' \OHat^{-1} \widehat{X}
...
An estimator of the covariance matrix of the estimated parameters is
\begin{equation}
   \COVHat \left[ \bHat_{W2SLS} \right] = \left( \widehat{X}' \OHat^{-1}
   \widehat{X} \right)^{-1} .
\end{equation}
...
\begin{equation}
   \bHat_{3SLS} = \left( \widehat{X}' \OHat^{-1} \widehat{X}
   \right)^{-1} \widehat{X}' \OHat^{-1} y ,
   \label{eq:3slsGls}
\end{equation}
where $\OHat = \SHat \otimes I$ and
...
An estimator of the covariance matrix of the estimated parameters is
\begin{equation}
   \COVHat \left[ \bHat_{3SLS} \right] = \left( \widehat{X}' \OHat^{-1}
   \widehat{X} \right)^{-1} .
   \label{eq:cov3sls}
\end{equation}
...
(3SLS-IV) is
\begin{equation}
   \bHat_{3SLS-IV} = \left( \widehat{X}' \OHat^{-1} X
   \right)^{-1} \widehat{X}' \OHat^{-1} y .
   \label{eq:3slsIv}
\end{equation}
An estimator of the covariance matrix of the estimated 3SLS-IV parameters is
\begin{equation}
   \COVHat \left[ \bHat_{3SLS-IV} \right] = \left( \widehat{X}' \OHat^{-1}
   X \right)^{-1} .
\end{equation}
...
\begin{equation}
   \bHat_{3SLS-Schmidt} = \left( \widehat{X}' \OHat^{-1} \widehat{X}
...
\begin{equation}
   ...
   \left( \widehat{X}' \OHat^{-1} \widehat{X} \right)^{-1}
   \widehat{X}' \OHat^{-1} \left( y - X \bHat_{2SLS} \right) ,
   \label{eq:3slsEViews}
\end{equation}
