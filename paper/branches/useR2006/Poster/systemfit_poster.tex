...
% Motivation
\posterbox{0.92\textwidth}{245mm}{linewidth=2mm, framearc=0.1,
   linecolor=lightblue, fillstyle=gradient, gradangle=0,
   gradbegin=white, gradend=whiteblue, gradmidpoint=1.0,
   framesep=1em}{
{\boxheaderfontsize \textbf{Motivation}}
{\standardfontsize
\begin{itemize}
\item many theoretical models consist of more than one equation\\
$\Rightarrow$ contemporaneously correlation of disturbance terms (likely)\\
$\Rightarrow$ \parbox[t]{0.95\textwidth}{\raggedright
   simultaneously estimation of all equations as 
...
$\Rightarrow$ simultaneous estimation of all equations required
...
\posterbox{0.92\textwidth}{}{linewidth=2mm, framearc=0.1,
   ...
   gradbegin=white, gradend=whiteblue, gradmidpoint=1.0,
   framesep=1em}{
{\boxheaderfontsize \textbf{Features of \texttt{systemfit}}}
{\standardfontsize
\begin{itemize}
...
\posterbox{0.92\textwidth}{245mm}{linewidth=2mm, framearc=0.1,
   ...
   gradbegin=white, gradend=whiteblue, gradmidpoint=1.0,
   framesep=1em}{
{\boxheaderfontsize \textbf{Example}}
{\standardfontsize
\begin{itemize}
\item from Kmenta (1986): Elements of Econometrics, p.~685
\item specification of the equation system:
   \bigskip\\
