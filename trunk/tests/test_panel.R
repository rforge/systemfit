...
coef( greeneOlsPooled, transformed = TRUE )
coef( summary( greeneOlsPooled ) )
coef( summary( greeneOlsPooled ), transformed = TRUE )
vcov( greeneOlsPooled )
vcov( greeneOlsPooled, transformed = TRUE )
...
coef( greeneSurPooled, transformed = TRUE )
coef( summary( greeneSurPooled ) )
coef( summary( greeneSurPooled ), transformed = TRUE )
vcov( greeneSurPooled )
vcov( greeneSurPooled, transformed = TRUE )
