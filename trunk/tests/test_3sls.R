...
for( i in seq( along = formulas ) ) {
   ...
   print( "************* 3SLS *********************************" )
   fit3sls[[ i ]]$e1 <- systemfit( system, "3SLS", labels, data = Kmenta,
      inst = inst, method3sls = formulas[ i ] )
   print( summary( fit3sls[[ i ]]$e1 ) )
   print( round( fit3sls[[ i ]]$e1$bcov, digits = 6 ) )

   print( "********************* 3SLS EViews-like *****************" )
   fit3sls[[ i ]]$e1e <- systemfit( system, "3SLS", labels, data = Kmenta,
      inst = inst, methodRCov = "noDfCor", probdfsys = TRUE, method3sls = formulas[ i ] )
   print( summary( fit3sls[[ i ]]$e1e ) )
   print( round( fit3sls[[ i ]]$e1e$bcov, digits = 6 ) )

   print( "********************* 3SLS with methodRCov = Theil *****************" )
   fit3sls[[ i ]]$e1c <- systemfit( system, "3SLS", labels, data = Kmenta,
      inst = inst, methodRCov = "Theil", probdfsys = TRUE, method3sls = formulas[ i ] )
   print( summary( fit3sls[[ i ]]$e1c ) )
   print( round( fit3sls[[ i ]]$e1c$bcov, digits = 6 ) )

   print( "*************** 3SLS with restriction *****************" )
   fit3sls[[ i ]]$e2 <- systemfit( system, "3SLS", labels, data = Kmenta,
   ...
   fit3sls[[ i ]]$e2e <- systemfit( system, "3SLS", labels, data = Kmenta,
      inst = inst, methodRCov = "noDfCor", probdfsys = TRUE, R.restr = restrm,
   ...
   fit3sls[[ i ]]$e3 <- systemfit( system, "3SLS", labels, data = Kmenta,
   ...
   fit3sls[[ i ]]$e3e <- systemfit( system, "3SLS", labels, data = Kmenta,
      inst = inst, methodRCov = "noDfCor", probdfsys = TRUE, TX = tc,
      method3sls = formulas[ i ] )
   print( summary( fit3sls[[ i ]]$e3e ) )
   print( round( fit3sls[[ i ]]$e3e$bcov, digits = 6 ) )

   print( "*************** 3SLS with 2 restrictions **********************" )
   fit3sls[[ i ]]$e4 <- systemfit( system, "3SLS", labels, data = Kmenta,
   ...
   fit3sls[[ i ]]$e4e <- systemfit( system, "3SLS", labels, data = Kmenta,
      inst = inst, methodRCov = "noDfCor", probdfsys = TRUE, R.restr = restr2m,
   ...
   fit3sls[[ i ]]$e5 <- systemfit( system, "3SLS", labels, data = Kmenta,
   ...
   fit3sls[[ i ]]$e5e <- systemfit( system, "3SLS", labels, data = Kmenta,
      inst = inst, TX = tc, methodRCov = "noDfCor", probdfsys = TRUE,
...
for( i in seq( along = formulas ) ) {
   ...
   print( paste( "3SLS formula:", formulas[ i ] ) )
   print( "************* 3SLS *********************************" )
   fit3slsi[[ i ]]$e1 <- systemfit( system, "3SLS", labels, data = Kmenta,
   ...
   fit3slsi[[ i ]]$e1e <- systemfit( system, "3SLS", labels, data = Kmenta,
      inst = inst, methodRCov = "noDfCor", probdfsys = TRUE, method3sls = formulas[ i ],
      maxiter = 100  )
   ...
   fit3slsi[[ i ]]$e1c <- systemfit( system, "3SLS", labels, data = Kmenta,
      inst = inst, methodRCov = "Theil", probdfsys = TRUE, method3sls = formulas[ i ],
      maxiter = 100  )
   ...
   fit3slsi[[ i ]]$e2 <- systemfit( system, "3SLS", labels, data = Kmenta,
   ...
   fit3slsi[[ i ]]$e2e <- systemfit( system, "3SLS", labels, data = Kmenta,
      inst = inst, methodRCov = "noDfCor", probdfsys = TRUE, R.restr = restrm,
   ...
   fit3slsi[[ i ]]$e3 <- systemfit( system, "3SLS", labels, data = Kmenta,
   ...
   fit3slsi[[ i ]]$e3e <- systemfit( system, "3SLS", labels, data = Kmenta,
      inst = inst, methodRCov = "noDfCor", probdfsys = TRUE, TX = tc,
      method3sls = formulas[ i ], maxiter = 100 )
   ...
   fit3slsi[[ i ]]$e4 <- systemfit( system, "3SLS", labels, data = Kmenta,
      inst = inst, R.restr = restr2m, q.restr = restr2q,
      method3sls = formulas[ i ], maxiter = 100 )
   ...
   fit3slsi[[ i ]]$e4e <- systemfit( system, "3SLS", labels, data = Kmenta,
      inst = inst, methodRCov = "noDfCor", probdfsys = TRUE, R.restr = restr2m,
   ...
   fit3slsi[[ i ]]$e5 <- systemfit( system, "3SLS", labels, data = Kmenta,
      inst = inst, TX = tc, R.restr = restr3m, q.restr = restr3q,
      method3sls = formulas[ i ], maxiter = 100 )
   ...
   fit3slsi[[ i ]]$e5e <- systemfit( system, "3SLS", labels, data = Kmenta,
      inst = inst, TX = tc, methodRCov = "noDfCor", probdfsys = TRUE,
      R.restr = restr3m, q.restr = restr3q, method3sls = formulas[ i ],
      maxiter = 100  )
...
for( i in seq( along = formulas ) ) {
   ...
   fit3slsd[[ i ]]$e1 <- systemfit( system, "3SLS", labels, data = Kmenta,
   ...
   fit3slsd[[ i ]]$e1e <- systemfit( system, "3SLS", labels, data = Kmenta,
      inst = instlist, methodRCov = "noDfCor", probdfsys = TRUE, method3sls = formulas[ i ] )
   ...
   fit3slsd[[ i ]]$e1c <- systemfit( system, "3SLS", labels, data = Kmenta,
      inst = instlist, methodRCov = "Theil", probdfsys = TRUE, method3sls = formulas[ i ] )
   ...
   fit3slsd[[ i ]]$e2 <- systemfit( system, "3SLS", labels, data = Kmenta,
   ...
   fit3slsd[[ i ]]$e2e <- systemfit( system, "3SLS", labels, data = Kmenta,
      inst = instlist, methodRCov = "noDfCor", probdfsys = TRUE, R.restr = restrm,
      method3sls = formulas[ i ] )
   ...
   fit3slsd[[ i ]]$e3 <- systemfit( system, "3SLS", labels, data = Kmenta,
   ...
   fit3slsd[[ i ]]$e3e <- systemfit( system, "3SLS", labels, data = Kmenta,
      inst = instlist, methodRCov = "noDfCor", probdfsys = TRUE, TX = tc,
      method3sls = formulas[ i ] )
   ...
   fit3slsd[[ i ]]$e4 <- systemfit( system, "3SLS", labels, data = Kmenta,
   ...
   fit3slsd[[ i ]]$e4e <- systemfit( system, "3SLS", labels, data = Kmenta,
      inst = instlist, methodRCov = "noDfCor", probdfsys = TRUE, R.restr = restr2m,
      q.restr = restr2q, method3sls = formulas[ i ] )
   print( summary( fit3slsd[[ i ]]$e4e ) )
   print( round( fit3slsd[[ i ]]$e4$bcov, digits = 6 ) )

   print( " 3SLS with different instruments with 2 restrictions via R and TX" )
   fit3slsd[[ i ]]$e5 <- systemfit( system, "3SLS", labels, data = Kmenta,
   ...
   fit3slsd[[ i ]]$e5e <- systemfit( system, "3SLS", labels, data = Kmenta,
      inst = instlist, TX = tc, methodRCov = "noDfCor", probdfsys = TRUE,
      R.restr = restr3m, q.restr = restr3q, method3sls = formulas[ i ] )
